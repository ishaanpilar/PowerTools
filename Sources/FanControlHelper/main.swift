...
private final class FanControlOwnership {
    private let lockPath = "/var/run/powertools-fan-control.lock"
    private let markerPath = "/var/run/powertools-fan-control.active"
...
private final class FanControlController {
    private let queue = DispatchQueue(label: "com.powertools.fan-control.helper")
