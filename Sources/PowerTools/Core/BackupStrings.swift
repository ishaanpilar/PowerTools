...
extension BackupFeatureStrings {
    static let ko = BackupFeatureStrings(
        ...
        invalidFile: "이 파일은 유효한 PowerTools 백업이 아닙니다."
    )
}
...
extension BackupFeatureStrings {
    ...
    static let ptBR = BackupFeatureStrings(
        ...
        invalidFile: "Este arquivo não é um backup válido do PowerTools."
    )
    ...
    static let tr = BackupFeatureStrings(
        ...
        invalidFile: "Bu dosya geçerli bir PowerTools yedeği değil."
    )
    ...
    static let ru = BackupFeatureStrings(
        ...
        invalidFile: "Этот файл не является корректной резервной копией PowerTools."
    )
    ...
    static let es = BackupFeatureStrings(
        ...
        invalidFile: "Este archivo no es una copia de seguridad válida de PowerTools."
    )
    ...
    static let de = BackupFeatureStrings(
        ...
        invalidFile: "Diese Datei ist kein gültiges PowerTools-Backup."
    )
    ...
    static let fr = BackupFeatureStrings(
        ...
        invalidFile: "Ce fichier n’est pas une sauvegarde PowerTools valide."
    )
    ...
    static let it = BackupFeatureStrings(
        ...
        invalidFile: "Questo file non è un backup PowerTools valido."
    )
    ...
    static let ja = BackupFeatureStrings(
        ...
        invalidFile: "このファイルは有効なPowerToolsのバックアップではありません。"
    )
    ...
    static let zhHans = BackupFeatureStrings(
        ...
        importAction: "导入并重启",
        invalidFile: "该文件不是有效的 PowerTools 备份。"
    )
    ...
    static let zhTW = BackupFeatureStrings(
        ...
        invalidFile: "此檔案不是有效的 PowerTools 備份。"
    )
    ...
    static let zhHK = BackupFeatureStrings(
        ...
        importConfirmBody: "目前設定將被檔案中的設定取代,App 會重新啟動。這台 Mac 上的其他內容不受影響。",
        importAction: "匯入並重新啟動",
        invalidFile: "此檔案不是有效嘅 PowerTools 備份。"
    )
}
