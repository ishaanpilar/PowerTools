...
extension BluetoothSleepStrings {
    ...
    static let ptBR = BluetoothSleepStrings(
        ...
        restoreCaption: "Apenas quando foi o PowerTools que o desligou.",
    ...
    static let tr = BluetoothSleepStrings(
        ...
        restoreCaption: "Yalnızca kapatan PowerTools olduğunda.",
    ...
    static let ru = BluetoothSleepStrings(
        ...
        restoreCaption: "Только если его выключил сам PowerTools.",
    ...
    static let es = BluetoothSleepStrings(
        ...
        restoreCaption: "Solo cuando fue PowerTools quien lo apagó.",
    ...
    static let de = BluetoothSleepStrings(
        ...
        restoreCaption: "Nur wenn PowerTools es ausgeschaltet hat.",
    ...
    static let fr = BluetoothSleepStrings(
        ...
        restoreCaption: "Uniquement si c’est PowerTools qui l’a coupé.",
    ...
    static let it = BluetoothSleepStrings(
        ...
        restoreCaption: "Solo quando è stato PowerTools a spegnerlo.",
    ...
    static let ja = BluetoothSleepStrings(
        ...
        restoreCaption: "PowerToolsが切った場合のみ戻します。",
    ...
    static let ko = BluetoothSleepStrings(
        ...
        restoreCaption: "PowerTools가 껐을 때만 다시 켭니다.",
    ...
    static let zhHans = BluetoothSleepStrings(
        ...
        restoreCaption: "仅在蓝牙是由 PowerTools 关闭时。",
    ...
    static let zhTW = BluetoothSleepStrings(
        ...
        restoreCaption: "僅在藍牙是由 PowerTools 關閉時。",
    ...
    static let zhHK = BluetoothSleepStrings(
        ...
        restoreToggle: "Mac 喚醒時重新開啟藍牙",
        restoreCaption: "只在藍牙是由 PowerTools 關閉時。",
