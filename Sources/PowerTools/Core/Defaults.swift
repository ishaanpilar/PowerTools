...
enum DefaultsKey {
    ...
    static let sleepDisabledFlag = "powerToolsDisabledSleep"   // internal guard for pmset disablesleep
    ...
    static let finderActionsEnabled = "finderActionsEnabled"
    ...
    // Set only while PowerTools owes a Bluetooth restore, so a Mac shut down
    ...
    static let panelSearchShortcutEnabled = "panelSearchShortcutEnabled"
    static let panelSearchShortcut = "panelSearchShortcut"
    ...
    static let screenshotHidePowerToolsWindows = "screenshotHidePowerToolsWindows"
...
enum KeepAwakeActiveIcon: String, CaseIterable, Identifiable {
    case powertools, coffee, eye, moon, light
    ...
    var menuBarDrop: CGFloat {
        ...
        case .powertools, .eye, .moon: return 0
        }
    }

    func title(_ strings: Strings) -> String {
        switch self {
        case .powertools: return strings.keepAwakeActiveIconPowerTools
...
enum Defaults {
    ...
    static let registeredDefaults: [String: Any] = [
        ...
        DefaultsKey.keepAwakeActiveIcon: KeepAwakeActiveIcon.powertools.rawValue,
        ...
        DefaultsKey.finderActionsEnabled: false,
        ...
        DefaultsKey.panelSearchShortcutEnabled: true,
        DefaultsKey.panelSearchShortcut: GlobalShortcut.panelSearchDefault.storageValue,
        ...
        DefaultsKey.screenshotHidePowerToolsWindows: true,
