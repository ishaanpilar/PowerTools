...
struct WindowLayoutFeatureStrings {
    ...
    static let enUS = WindowLayoutFeatureStrings(
        ...
        edgeSnapSystemConflict: "macOS is using the same edges. Turn off window tiling in Desktop & Dock so PowerTools AI can take over.",
        edgeSnapOpenSystemSettings: "Open Desktop & Dock",
        edgeSnapWaitingForSystem: "Enabled in PowerTools AI. It starts working as soon as macOS tiling is off.",
...
struct MonitorAlertFeatureStrings {
    ...
    static let enUS = MonitorAlertFeatureStrings(
        ...
        notificationsDenied: "Notifications for PowerTools AI are off in System Settings, so alerts cannot appear.",
        cpu: "High CPU",
