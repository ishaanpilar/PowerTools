...
extension KillProcessFeatureStrings {
    ...
    static let ptBR = KillProcessFeatureStrings(
        ...
        adminPromptFormat: "O PowerTools precisa de acesso de administrador para encerrar “%@”."
    )
    ...
    static let tr = KillProcessFeatureStrings(
        ...
        adminPromptFormat: "PowerTools’in “%@” işlemini sonlandırması için yönetici erişimi gerekiyor."
    )
    ...
    static let ru = KillProcessFeatureStrings(
        ...
        adminPromptFormat: "PowerTools нужны права администратора, чтобы завершить «%@»."
    )
    ...
    static let es = KillProcessFeatureStrings(
        ...
        adminPromptFormat: "PowerTools necesita acceso de administrador para finalizar “%@”."
    )
    ...
    static let de = KillProcessFeatureStrings(
        ...
        adminPromptFormat: "PowerTools benötigt Administratorrechte, um „%@“ zu beenden."
    )
    ...
    static let fr = KillProcessFeatureStrings(
        ...
        adminPromptFormat: "PowerTools a besoin d’un accès administrateur pour arrêter «\u{00A0}%@\u{00A0}»."
    )
    ...
    static let it = KillProcessFeatureStrings(
        ...
        adminPromptFormat: "PowerTools richiede l’accesso da amministratore per terminare “%@”."
    )
    ...
    static let zhHans = KillProcessFeatureStrings(
        ...
        adminPromptFormat: "PowerTools 需要您的管理员密码才能结束“%@”。"
    )
    ...
    static let zhTW = KillProcessFeatureStrings(
        ...
        adminPromptFormat: "PowerTools 需要管理員權限才能結束「%@」。"
    )
