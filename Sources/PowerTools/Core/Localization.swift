...
extension Strings {
    static let enUS = Strings(
        statusIdleTooltip: "PowerTools: normal sleep",
        statusActiveUntil: "PowerTools: awake until",
        statusActiveIndefinite: "PowerTools: awake indefinitely",
        menuEnableAwake: "Enable keep awake",
        menuDisableAwake: "Disable keep awake",
        menuActivateFor: "Activate for…",
        menuSettings: "Settings…",
        menuAbout: "About PowerTools",
        menuQuit: "Quit PowerTools",
        menuHide: "Hide PowerTools",
        ...
        notifyBatteryTitle: "PowerTools disabled",
        notifyBatteryBody: "Low battery. Normal sleep was restored to protect the charge.",
        adminPromptClamshellOn: "PowerTools needs your password to keep the Mac going with the lid closed.",
        adminPromptClamshellOff: "PowerTools needs your password to restore the Mac’s normal sleep.",
        adminPromptRecover: "PowerTools quit while the Mac’s sleep was disabled. Enter the password to restore normal sleep.",
        adminPromptUpdate: "PowerTools needs your password to install the update.",
        adminPromptSudoersInstall: "PowerTools will create a restricted rule (pmset disablesleep only) to toggle closed-lid mode without asking for a password. This is the only time the password is needed.",
        adminPromptSudoersRemove: "PowerTools will remove the password-free closed-lid rule.",

        settingsTitle: "PowerTools Settings",
        tabGeneral: "General",
        tabEnergy: "Energy",
        ...
        advancedResetDescription: "Removes every permission you granted PowerTools (Accessibility, Screen Recording, Full Disk Access and others), the login item and the closed-lid rule. Useful to start fresh or before uninstalling. The app stays installed.",
        ...
        advancedUninstallDescription: "Does all of the above, then removes the preferences and moves PowerTools to the Trash, leaving nothing behind. The app quits when done. You can reinstall anytime.",
        advancedUninstallButton: "Uninstall PowerTools completely",
        advancedUninstallConfirmTitle: "Uninstall PowerTools?",
        advancedUninstallConfirmBody: "PowerTools will clear its permissions, remove its preferences and move to the Trash, then quit. This can’t be undone from the app, but it stays in the Trash until you empty it.",
        advancedUninstallFailedTitle: "Uninstall stopped",
        advancedUninstallFailedBody: "PowerTools could not put back a system setting it changed: sleep, fan speed or mouse acceleration. Nothing was removed. Try again and allow the password request if it appears.",
        ...
        keepAwakeAutoStart: "Keep Awake when PowerTools opens",
        ...
        switcherEnable: "Use the PowerTools switcher",
        ...
        switcherTakeOverSystemShortcutsCaption: "Disables the matching macOS app and window shortcuts only while PowerTools’s switcher is active. All running apps stay reachable.",
        ...
        uninstallerFDAHint: "Turn PowerTools on in the list. If it isn’t there, click + and pick PowerTools from Applications. Access only applies after you reopen the app.",
        ...
        homebrewMissingBody: "PowerTools can open Terminal with the official Homebrew installer. Terminal shows the steps and asks for your password if needed.",
        ...
        homebrewShellSetupBody: "Homebrew is installed, but Terminal may not find the brew command yet. PowerTools can open Terminal with the setup command.",
        ...
        homebrewTerminalFallback: "This operation needs Terminal to ask for the administrator password. PowerTools does not capture passwords.",
        ...
        updateNotifyTitle: "PowerTools update",
        ...
        updateNeedsApplicationsTitle: "Move PowerTools to Applications",
        updateNeedsApplicationsBody: "The app is running from a place that cannot be updated, such as the disk image or a temporary system location. Drag PowerTools to the Applications folder, open it from there and try again.",
        ...
        obStart: "Open PowerTools",
        obStepWelcomeTitle: "Welcome to PowerTools",
        ...
        obStepDoneBody: "PowerTools is already looking after your Mac.",
        obDoneHint: "Look for the PowerTools icon in the menu bar, at the top right of the screen.",
        ...
        obLanguageUpdateBody: "PowerTools now speaks several languages. Choose the one you’d like to use; you can change it anytime in Settings.",
        ...
        cleaningNeedsAxBody: "To lock the keyboard safely, PowerTools needs Accessibility permission. Grant it in System Settings and try again.",
        ...
        donateHeading: "Help PowerTools keep growing",
        donateMessage: "PowerTools is free, independent and built in my spare time. If you would like to contribute financially, Buy Me a Coffee directly helps me keep development moving forward.",
        donateButton: "Support on Buy Me a Coffee",
        donateThanks: "Thank you for being here. 🖤",
        supportIntroTitle: "Help PowerTools keep growing",
        supportIntroMessage: "If you would like to support development financially, Buy Me a Coffee is the one place to do it.",
        supportIntroStarButton: "Star PowerTools on GitHub",
        supportIntroStarMessage: "Financial support is never expected. A star on GitHub helps more people discover PowerTools and makes a real difference to its development.",
        supportIntroCoffeeButton: "Support on Buy Me a Coffee",
        supportIntroLaterButton: "Not now",
        supportIntroDoneButton: "Done",
        discordIntroTitle: "The PowerTools Discord community is just getting started",
        discordIntroMessage: "The PowerTools community is new and still being built. Join early to meet other users and help build a welcoming space around the app.",
        ...
        homebrewOfficialIntroMessage: "PowerTools can now be installed directly from the official Homebrew catalog.",
        ...
        showMenuBarIconCaption: "If PowerTools’s icon disappears (macOS can hide menu bar icons when the bar runs out of room, common on Macs with a notch), reopen PowerTools from Applications or Spotlight: that rebuilds the icon and, if it’s still hidden, opens this window.",
        ...
        menuBarIconManagerHintFormat: "%@ is open and may be keeping the icon in its hidden section. Look for PowerTools there, or set %@ to always show PowerTools.",
        ...
        cleanerNotifDenied: "PowerTools notifications are turned off in the system.",
        cleanerNotifOpenSettings: "Open Notification Settings…",
        launchAtLoginNeedsApplications: "The app is running from a place that cannot open at login. Drag PowerTools to the Applications folder, open it from there and turn this on again.",
        launchAtLoginNeedsApproval: "The login item is registered but still switched off in System Settings. Open System Settings › General › Login Items & Extensions and turn PowerTools on under Open at Login.",
        ...
        mouseAccelerationCaption: "Removes pointer acceleration for connected mice. Your previous setting returns when this is turned off or PowerTools quits.",
