...
struct Strings {
    ...
    let keepAwakeActiveIconPowerTools: String
...
extension Strings {
    static let ptBR = Strings(
        statusIdleTooltip: "PowerTools: suspensão normal",
        statusActiveUntil: "PowerTools: ativo até",
        statusActiveIndefinite: "PowerTools: ativo indefinidamente",
        menuEnableAwake: "Ativar manter acordado",
        menuDisableAwake: "Desativar manter acordado",
        menuActivateFor: "Ativar por…",
        menuSettings: "Ajustes…",
        menuAbout: "Sobre o PowerTools",
        menuQuit: "Sair do PowerTools",
        menuHide: "Ocultar o PowerTools",
        ...
        notifyBatteryTitle: "PowerTools desativado",
        notifyBatteryBody: "Bateria baixa. A suspensão normal foi restaurada para proteger a carga.",
        adminPromptClamshellOn: "O PowerTools precisa da sua senha para manter o Mac ativo com a tampa fechada.",
        adminPromptClamshellOff: "O PowerTools precisa da sua senha para reativar a suspensão normal do Mac.",
        adminPromptRecover: "O PowerTools foi encerrado com a suspensão do Mac desativada. Digite a senha para restaurar a suspensão normal.",
        adminPromptUpdate: "O PowerTools precisa da sua senha para instalar a atualização.",
        adminPromptSudoersInstall: "O PowerTools vai criar uma regra restrita (somente pmset disablesleep) para alternar a tampa fechada sem pedir senha. Esta é a única vez que a senha será necessária.",
        adminPromptSudoersRemove: "O PowerTools vai remover a regra de tampa fechada sem senha.",

        settingsTitle: "Ajustes do PowerTools",
        tabGeneral: "Geral",
        tabEnergy: "Energia",
        ...
        advancedResetDescription: "Remove todas as permissões que você concedeu ao PowerTools (Acessibilidade, Gravação de Tela, Acesso Total ao Disco e outras), o item de início e a regra de tampa fechada. Útil para começar do zero ou antes de desinstalar. O app continua instalado.",
        ...
        advancedUninstallDescription: "Faz tudo acima e ainda apaga as preferências e move o PowerTools para a Lixeira, sem deixar rastro no sistema. O app fecha ao final. Você pode reinstalar quando quiser.",
        advancedUninstallButton: "Desinstalar o PowerTools completamente",
        advancedUninstallConfirmTitle: "Desinstalar o PowerTools?",
        advancedUninstallConfirmBody: "O PowerTools vai limpar as permissões, apagar as preferências e ir para a Lixeira, e então fechar. Esta ação não pode ser desfeita pelo app, mas ele fica na Lixeira até você esvaziá-la.",
        advancedUninstallFailedTitle: "A desinstalação parou",
        advancedUninstallFailedBody: "O PowerTools não conseguiu restaurar uma configuração do sistema que ele mudou: repouso, velocidade das ventoinhas ou aceleração do mouse. Nada foi removido. Tente de novo e permita o pedido de senha, se ele aparecer.",
        ...
        keepAwakeAutoStart: "Manter acordado ao abrir o PowerTools",
        ...
        switcherEnable: "Usar o alternador do PowerTools",
        ...
        switcherTakeOverSystemShortcutsCaption: "Desativa os atalhos correspondentes de apps e janelas do macOS somente enquanto o alternador do PowerTools estiver ativo. Todos os apps abertos continuam acessíveis.",
        ...
        uninstallerFDAHint: "Ative o PowerTools na lista. Se ele não aparecer, clique no + e escolha o PowerTools em Aplicativos. O acesso só vale depois de reabrir o app.",
        ...
        homebrewMissingBody: "O PowerTools pode abrir o Terminal com o instalador oficial do Homebrew. O Terminal mostra os passos e pede sua senha se precisar.",
        ...
        homebrewShellSetupBody: "O Homebrew está instalado, mas o Terminal ainda pode não encontrar o comando brew. O PowerTools pode abrir o Terminal com o comando de configuração.",
        ...
        homebrewTerminalFallback: "Esta operação precisa do Terminal para pedir a senha de administrador. O PowerTools não captura senhas.",
        ...
        updateNotifyTitle: "Atualização do PowerTools",
        ...
        updateNeedsApplicationsTitle: "Mova o PowerTools para Aplicativos",
        updateNeedsApplicationsBody: "O app está rodando de um lugar que não dá para atualizar, como a imagem de disco ou uma área temporária do sistema. Arraste o PowerTools para a pasta Aplicativos, abra de lá e tente de novo.",
        ...
        obStart: "Abrir o PowerTools",
        obStepWelcomeTitle: "Bem-vindo ao PowerTools",
        ...
        obStepDoneBody: "O PowerTools já está cuidando do seu Mac.",
        obDoneHint: "Procure o ícone do PowerTools na barra de menus, no canto superior direito da tela.",
        ...
        obLanguageUpdateBody: "O PowerTools agora fala vários idiomas. Escolha o que você prefere usar; dá para mudar quando quiser nos Ajustes.",
        ...
        cleaningNeedsAxBody: "Para bloquear o teclado com segurança, o PowerTools precisa da permissão de Acessibilidade. Conceda em Ajustes do Sistema e tente de novo.",
        ...
        donateHeading: "Ajude o PowerTools a continuar crescendo",
        donateMessage: "O PowerTools é gratuito, independente e desenvolvido no meu tempo livre. Se você quiser contribuir financeiramente, o Buy Me a Coffee ajuda diretamente a manter o desenvolvimento avançando.",
        donateButton: "Apoiar no Buy Me a Coffee",
        donateThanks: "Obrigado por estar aqui. 🖤",
        supportIntroTitle: "Ajude o PowerTools a continuar crescendo",
        ...
        supportIntroStarMessage: "Apoio financeiro nunca é esperado. Dar uma estrela no GitHub ajuda mais pessoas a encontrar o PowerTools e faz uma diferença enorme no desenvolvimento.",
        supportIntroCoffeeButton: "Apoiar no Buy Me a Coffee",
        supportIntroLaterButton: "Agora não",
        supportIntroDoneButton: "Concluir",
        discordIntroTitle: "A comunidade do PowerTools no Discord está começando",
        discordIntroMessage: "A comunidade do PowerTools é nova e ainda está em desenvolvimento. Entre desde o começo para conhecer outros usuários e ajudar a construir um espaço acolhedor em torno do app.",
        ...
        communityIntroFollowButton: "Seguir @powertools no X",
        homebrewOfficialIntroTitle: "Agora no catálogo oficial do Homebrew",
        homebrewOfficialIntroMessage: "O PowerTools agora pode ser instalado direto do catálogo oficial do Homebrew.",
        ...
        showMenuBarIconCaption: "Se o ícone do PowerTools sumir (o macOS pode esconder ícones quando a barra de menus fica sem espaço, comum em Macs com notch), reabra o PowerTools pela pasta Aplicativos ou pelo Spotlight: isso recria o ícone e, se ele ainda estiver escondido, abre esta janela.",
        ...
        menuBarIconManagerHintFormat: "O %@ está aberto e pode estar guardando o ícone na seção oculta dele. Procure o PowerTools lá, ou configure o %@ para sempre mostrar o PowerTools.",
        ...
        cleanerNotifDenied: "As notificações do PowerTools estão desativadas no sistema.",
        cleanerNotifOpenSettings: "Abrir Ajustes de Notificações…",
        launchAtLoginNeedsApplications: "O app está rodando de um lugar que não permite abrir no login. Arraste o PowerTools para a pasta Aplicativos, abra de lá e ligue de novo.",
        launchAtLoginNeedsApproval: "O item de login está registrado, mas continua desligado nos Ajustes do Sistema. Abra Ajustes do Sistema › Geral › Itens de Início e Extensões e ligue o PowerTools em “Abrir ao iniciar sessão”.",
        ...
        mouseAccelerationCaption: "Remove a aceleração do cursor para os mouses conectados. A configuração anterior volta ao desligar esta opção ou sair do PowerTools.",
...
extension Strings {
    static let enUS = Strings(
        statusIdleTooltip: "PowerTools AI: normal sleep",
        statusActiveUntil: "PowerTools AI: awake until",
        statusActiveIndefinite: "PowerTools AI: awake indefinitely",
        menuEnableAwake: "Enable keep awake",
        menuDisableAwake: "Disable keep awake",
        menuActivateFor: "Activate for…",
        menuSettings: "Settings…",
        menuAbout: "About PowerTools AI",
        menuQuit: "Quit PowerTools AI",
        menuHide: "Hide PowerTools AI",
        ...
        monitorSensorsCaption: "Every temperature sensor this Mac reports, read live while the list is open. Sensors marked CPU are the ones PowerTools AI uses for the CPU temperature.",
        ...
        notifyBatteryTitle: "PowerTools AI disabled",
        notifyBatteryBody: "Low battery. Normal sleep was restored to protect the charge.",
        adminPromptClamshellOn: "PowerTools AI needs your password to keep the Mac going with the lid closed.",
        adminPromptClamshellOff: "PowerTools AI needs your password to restore the Mac’s normal sleep.",
        adminPromptRecover: "PowerTools AI quit while the Mac’s sleep was disabled. Enter the password to restore normal sleep.",
        adminPromptUpdate: "PowerTools AI needs your password to install the update.",
        adminPromptSudoersInstall: "PowerTools AI will create a restricted rule (pmset disablesleep only) to toggle closed-lid mode without asking for a password. This is the only time the password is needed.",
        adminPromptSudoersRemove: "PowerTools AI will remove the password-free closed-lid rule.",

        settingsTitle: "PowerTools AI Settings",
        tabGeneral: "General",
        tabEnergy: "Energy",
        ...
        advancedResetDescription: "Removes every permission you granted PowerTools AI (Accessibility, Screen Recording, Full Disk Access and others), the login item and the closed-lid rule. Useful to start fresh or before uninstalling. The app stays installed.",
        ...
        advancedUninstallDescription: "Does all of the above, then removes the preferences and moves PowerTools AI to the Trash, leaving nothing behind. The app quits when done. You can reinstall anytime.",
        advancedUninstallButton: "Uninstall PowerTools AI completely",
        advancedUninstallConfirmTitle: "Uninstall PowerTools AI?",
        advancedUninstallConfirmBody: "PowerTools AI will clear its permissions, remove its preferences and move to the Trash, then quit. This can’t be undone from the app, but it stays in the Trash until you empty it.",
        advancedUninstallFailedTitle: "Uninstall stopped",
        advancedUninstallFailedBody: "PowerTools AI could not put back a system setting it changed: sleep, fan speed or mouse acceleration. Nothing was removed. Try again and allow the password request if it appears.",
        ...
        keepAwakeAutoStart: "Keep Awake when PowerTools AI opens",
        ...
        switcherEnable: "Use the PowerTools AI switcher",
        ...
        switcherTakeOverSystemShortcutsCaption: "Disables the matching macOS app and window shortcuts only while PowerTools AI’s switcher is active. All running apps stay reachable.",
        ...
        uninstallerFDAHint: "Turn PowerTools AI on in the list. If it isn’t there, click + and pick PowerTools AI from Applications. Access only applies after you reopen the app.",
        ...
        homebrewMissingBody: "PowerTools AI can open Terminal with the official Homebrew installer. Terminal shows the steps and asks for your password if needed.",
        ...
        homebrewShellSetupBody: "Homebrew is installed, but Terminal may not find the brew command yet. PowerTools AI can open Terminal with the setup command.",
        ...
        homebrewTerminalFallback: "This operation needs Terminal to ask for the administrator password. PowerTools AI does not capture passwords.",
        ...
        updateNotifyTitle: "PowerTools AI update",
        ...
        updateNeedsApplicationsTitle: "Move PowerTools AI to Applications",
        updateNeedsApplicationsBody: "The app is running from a place that cannot be updated, such as the disk image or a temporary system location. Drag PowerTools AI to the Applications folder, open it from there and try again.",
        ...
        obStart: "Open PowerTools AI",
        obStepWelcomeTitle: "Welcome to PowerTools AI",
        ...
        obStepDoneBody: "PowerTools AI is already looking after your Mac.",
        obDoneHint: "Look for the PowerTools AI icon in the menu bar, at the top right of the screen.",
        ...
        obLanguageUpdateBody: "PowerTools AI now speaks several languages. Choose the one you’d like to use; you can change it anytime in Settings.",
        ...
        cleaningNeedsAxBody: "To lock the keyboard safely, PowerTools AI needs Accessibility permission. Grant it in System Settings and try again.",
        ...
        donateHeading: "Help PowerTools AI keep growing",
        donateMessage: "PowerTools AI is free, independent and built in my spare time. If you would like to contribute financially, Buy Me a Coffee directly helps me keep development moving forward.",
        donateButton: "Support on Buy Me a Coffee",
        donateThanks: "Thank you for being here. 🖤",
        supportIntroTitle: "Help PowerTools AI keep growing",
        supportIntroMessage: "If you would like to support development financially, Buy Me a Coffee is the one place to do it.",
        supportIntroStarButton: "Star PowerTools AI on GitHub",
        supportIntroStarMessage: "Financial support is never expected. A star on GitHub helps more people discover PowerTools AI and makes a real difference to its development.",
        supportIntroCoffeeButton: "Support on Buy Me a Coffee",
        supportIntroLaterButton: "Not now",
        supportIntroDoneButton: "Done",
        discordIntroTitle: "The PowerTools AI Discord community is just getting started",
        discordIntroMessage: "The PowerTools AI community is new and still being built. Join early to meet other users and help build a welcoming space around the app.",
        ...
        communityIntroFollowButton: "Follow @powertools on X",
        homebrewOfficialIntroTitle: "Now in the official Homebrew catalog",
        homebrewOfficialIntroMessage: "PowerTools AI can now be installed directly from the official Homebrew catalog.",
        ...
        showMenuBarIconCaption: "If PowerTools AI’s icon disappears (macOS can hide menu bar icons when the bar runs out of room, common on Macs with a notch), reopen PowerTools AI from Applications or Spotlight: that rebuilds the icon and, if it’s still hidden, opens this window.",
        ...
        menuBarIconManagerHintFormat: "%@ is open and may be keeping the icon in its hidden section. Look for PowerTools AI there, or set %@ to always show PowerTools AI.",
        ...
        cleanerNotifDenied: "PowerTools AI notifications are turned off in the system.",
        cleanerNotifOpenSettings: "Open Notification Settings…",
        launchAtLoginNeedsApplications: "The app is running from a place that cannot open at login. Drag PowerTools AI to the Applications folder, open it from there and turn this on again.",
        launchAtLoginNeedsApproval: "The login item is registered but still switched off in System Settings. Open System Settings › General › Login Items & Extensions and turn PowerTools AI on under Open at Login.",
        ...
        mouseAccelerationCaption: "Removes pointer acceleration for connected mice. Your previous setting returns when this is turned off or PowerTools AI quits.",
