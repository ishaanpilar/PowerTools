...
extension Strings {
    static let de = Strings(
        statusIdleTooltip: "PowerTools: normaler Ruhezustand",
        statusActiveUntil: "PowerTools: aktiv bis",
        statusActiveIndefinite: "PowerTools: dauerhaft aktiv",
        menuEnableAwake: "Wachhalten aktivieren",
        menuDisableAwake: "Wachhalten deaktivieren",
        menuActivateFor: "Aktivieren für…",
        menuSettings: "Einstellungen…",
        menuAbout: "Über PowerTools",
        menuQuit: "PowerTools beenden",
        menuHide: "PowerTools ausblenden",
        ...
        thermalPressureLabel: "Thermik",
        thermalNominal: "Normal",
        thermalModerate: "Moderat",
        thermalHeavy: "Hoch",
        thermalCritical: "Kritisch",
        cpuSpeedLimitLabel: "CPU-Limit",
        monitorSensorsSection: "Sensoren",
        monitorSensorsCaption: "Alle Temperatursensoren, die dieser Mac meldet, live gelesen, solange die Liste offen ist. Mit CPU markierte Sensoren nutzt PowerTools für die CPU-Temperatur.",
        monitorSensorsShow: "Alle Sensoren anzeigen",
        monitorSensorsEmpty: "Dieser Mac meldet keine Temperatursensoren.",
        monitorSensorsCountFormat: "Sensoren: %d",
        ...
        notifyBatteryTitle: "PowerTools deaktiviert",
        notifyBatteryBody: "Niedriger Batteriestand. Der normale Ruhezustand wurde wiederhergestellt, um die Ladung zu schonen.",
        adminPromptClamshellOn: "PowerTools benötigt dein Passwort, um bei zugeklapptem Mac weiterzulaufen.",
        adminPromptClamshellOff: "PowerTools benötigt dein Passwort, um den normalen Ruhezustand des Mac wiederherzustellen.",
        adminPromptRecover: "PowerTools wurde beendet, während der Ruhezustand des Mac deaktiviert war. Gib das Passwort ein, um den normalen Ruhezustand wiederherzustellen.",
        adminPromptUpdate: "PowerTools benötigt dein Passwort, um das Update zu installieren.",
        adminPromptSudoersInstall: "PowerTools legt eine eingeschränkte Regel an (nur pmset disablesleep), um den Modus bei geschlossenem Display ohne Passwortabfrage umzuschalten. Nur dieses eine Mal wird das Passwort benötigt.",
        adminPromptSudoersRemove: "PowerTools entfernt die passwortfreie Regel für das geschlossene Display.",

        settingsTitle: "PowerTools-Einstellungen",
        ...
        advancedResetDescription: "Entfernt alle Berechtigungen, die du PowerTools erteilt hast (Bedienungshilfen, Bildschirmaufnahme, Festplattenvollzugriff und weitere), das Anmeldeobjekt und die Regel für das geschlossene Display. Praktisch für einen Neustart oder vor dem Deinstallieren. Die App bleibt installiert.",
        ...
        advancedUninstallDescription: "Macht alles oben Genannte, entfernt dann die Einstellungen und bewegt PowerTools in den Papierkorb, ohne Rückstände zu hinterlassen. Die App beendet sich danach. Du kannst sie jederzeit neu installieren.",
        advancedUninstallButton: "PowerTools vollständig deinstallieren",
        advancedUninstallConfirmTitle: "PowerTools deinstallieren?",
        advancedUninstallConfirmBody: "PowerTools setzt seine Berechtigungen zurück, entfernt seine Einstellungen und wandert in den Papierkorb, dann beendet es sich. Das lässt sich aus der App nicht rückgängig machen, doch sie bleibt im Papierkorb, bis du ihn leerst.",
        advancedUninstallFailedTitle: "Deinstallation gestoppt",
        advancedUninstallFailedBody: "PowerTools konnte eine geänderte Systemeinstellung nicht wiederherstellen: Ruhezustand, Lüfterdrehzahl oder Mausbeschleunigung. Es wurde nichts entfernt. Versuche es erneut und erlaube die Kennwortabfrage, falls sie erscheint.",
        ...
        keepAwakeAutoStart: "Beim Öffnen von PowerTools wach halten",
        ...
        switcherEnable: "PowerTools-Umschalter verwenden",
        ...
        switcherTakeOverSystemShortcutsCaption: "Deaktiviert die passenden macOS-App- und Fensterkurzbefehle nur, solange der PowerTools-Umschalter aktiv ist. Alle laufenden Apps bleiben erreichbar.",
        ...
        uninstallerFDAHint: "Aktiviere PowerTools in der Liste. Fehlt es dort, klicke auf + und wähle PowerTools unter „Programme“. Der Zugriff gilt erst, nachdem du die App erneut öffnest.",
        ...
        homebrewMissingBody: "PowerTools kann Terminal mit dem offiziellen Homebrew-Installer öffnen. Terminal zeigt die Schritte und fragt bei Bedarf nach deinem Passwort.",
        ...
        homebrewShellSetupBody: "Homebrew ist installiert, aber Terminal findet den Befehl brew vielleicht noch nicht. PowerTools kann Terminal mit dem Konfigurationsbefehl öffnen.",
        ...
        homebrewTerminalFallback: "Diese Aktion benötigt Terminal, um nach dem Administratorpasswort zu fragen. PowerTools erfasst keine Passwörter.",
        ...
        updateNeedsApplicationsTitle: "Bewege PowerTools in den Ordner „Programme“",
        updateNeedsApplicationsBody: "Die App läuft an einem Ort, der nicht aktualisiert werden kann, etwa im Disk-Image oder an einem temporären Systemort. Ziehe PowerTools in den Ordner „Programme“, öffne es von dort und versuche es erneut.",
        ...
        obStart: "PowerTools öffnen",
        obStepWelcomeTitle: "Willkommen bei PowerTools",
        ...
        obLanguageUpdateBody: "PowerTools spricht jetzt mehrere Sprachen. Wähle die, die du verwenden möchtest; du kannst sie jederzeit in den Einstellungen ändern.",
        ...
        diskCriticallyLow: "Kritisch wenig Speicherplatz",
        diskReclaimableFormat: "Bis zu %@ können freigegeben werden",
        diskOpenCleaner: "Cleaner öffnen",
        healthGreetingMorning: "Morgen",
        healthGreetingAfternoon: "Tag",
        healthGreetingEvening: "Abend",
        healthGreetingHello: "Hallo",
        healthGreetingHi: "Hi",
        healthGreetingHey: "Hey",
        healthGreetingHowdy: "Servus",
        healthGreetingGreetings: "Grüße",
        healthGreetingNameFormat: "%1$@, %2$@!",
        healthEverythingGood: "Alles sieht gut aus.",
        healthBatteryCriticallyLow: "Dein Akku ist kritisch niedrig.",
        healthThermalCritical: "Dein Mac wird gerade gedrosselt.",
        healthMemoryCritical: "Der Arbeitsspeicher steht gerade stark unter Druck.",
        healthDiskCriticallyLow: "Alles sieht gut aus, außer dem Speicherplatz.",
        diskInternal: "Intern",
        diskExternal: "Extern",
        ...
        monitorRefreshingLabel: "Wird aktualisiert…",
        ...
        cleaningNeedsAxBody: "Um die Tastatur sicher zu sperren, benötigt PowerTools die Berechtigung für Bedienungshilfen. Erteile sie in den Systemeinstellungen und versuche es erneut.",
        ...
        donateHeading: "Hilf PowerTools weiter zu wachsen",
        donateMessage: "PowerTools ist kostenlos, unabhängig und entsteht in meiner Freizeit. Wenn du die Entwicklung finanziell unterstützen möchtest, hilft Buy Me a Coffee direkt dabei, sie voranzubringen.",
        donateButton: "Über Buy Me a Coffee unterstützen",
        donateThanks: "Danke, dass du hier bist. 🖤",
        supportIntroTitle: "Hilf PowerTools weiter zu wachsen",
        supportIntroMessage: "Wenn du die Entwicklung finanziell unterstützen möchtest, ist Buy Me a Coffee der einzige Ort dafür.",
        supportIntroStarButton: "PowerTools auf GitHub einen Stern geben",
        supportIntroStarMessage: "Finanzielle Unterstützung wird nie erwartet. Ein Stern auf GitHub hilft mehr Menschen, PowerTools zu entdecken, und macht für die Entwicklung einen echten Unterschied.",
        ...
        discordIntroTitle: "Die PowerTools Community auf Discord steht noch am Anfang",
        discordIntroMessage: "Die PowerTools Community ist neu und wächst noch. Tritt früh bei, lerne andere Nutzer kennen und hilf, einen einladenden Ort rund um die App aufzubauen.",
        ...
        communityIntroFollowButton: "@powertools auf X folgen",
        homebrewOfficialIntroTitle: "Jetzt im offiziellen Katalog von Homebrew",
        homebrewOfficialIntroMessage: "PowerTools kann jetzt direkt aus dem offiziellen Katalog von Homebrew installiert werden.",
        ...
        showMenuBarIconCaption: "Falls das Symbol von PowerTools verschwindet (macOS kann Menüleistensymbole ausblenden, wenn der Platz in der Leiste knapp wird, häufig bei Macs mit Notch), öffne PowerTools erneut über „Programme“ oder Spotlight: Das stellt das Symbol wieder her und öffnet, falls es weiterhin ausgeblendet ist, dieses Fenster.",
        ...
        menuBarIconManagerHintFormat: "%@ läuft und hält das Symbol womöglich in seinem verborgenen Bereich. Suche PowerTools dort, oder stelle %@ so ein, dass PowerTools immer angezeigt wird.",
        ...
        cleanerNotifDenied: "Mitteilungen von PowerTools sind im System deaktiviert.",
        cleanerNotifOpenSettings: "Mitteilungseinstellungen öffnen…",
        launchAtLoginNeedsApplications: "Die App läuft von einem Ort, der das Öffnen bei der Anmeldung nicht erlaubt. Ziehe PowerTools in den Ordner Programme, öffne die App von dort und schalte die Option wieder ein.",
        launchAtLoginNeedsApproval: "Das Anmeldeobjekt ist registriert, in den Systemeinstellungen aber weiterhin aus. Öffne Systemeinstellungen › Allgemein › Anmeldeobjekte & Erweiterungen und schalte PowerTools unter „Bei der Anmeldung öffnen“ ein.",
        ...
        mouseAccelerationCaption: "Deaktiviert die Zeigerbeschleunigung für angeschlossene Mäuse. Die vorherige Einstellung wird beim Ausschalten oder Beenden von PowerTools wiederhergestellt.",
