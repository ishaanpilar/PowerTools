...
extension Strings {
    static let ja = Strings(
        statusIdleTooltip: "PowerTools：通常のスリープ",
        statusActiveUntil: "PowerTools：次の時刻までスリープしない",
        statusActiveIndefinite: "PowerTools：解除するまでスリープしない",
        menuEnableAwake: "スリープ防止をオン",
        menuDisableAwake: "スリープ防止をオフ",
        menuActivateFor: "時間を指定してオン…",
        menuSettings: "設定…",
        menuAbout: "PowerTools について",
        menuQuit: "PowerTools を終了",
        menuHide: "PowerTools を隠す",
        ...
        systemSection: "システム",
        temperatures: "温度",
        thermalPressureLabel: "熱状態",
        thermalNominal: "標準",
        thermalModerate: "中程度",
        thermalHeavy: "高",
        thermalCritical: "重大",
        cpuSpeedLimitLabel: "CPU制限",
        monitorSensorsSection: "センサー",
        monitorSensorsCaption: "このMacが報告するすべての温度センサーです。リストを開いている間はリアルタイムで読み取ります。CPUと表示されたセンサーは、PowerToolsがCPU温度に使用しているものです。",
        monitorSensorsShow: "すべてのセンサーを表示",
        monitorSensorsEmpty: "このMacは温度センサーを報告していません。",
        monitorSensorsCountFormat: "センサー: %d",
        ...
        notifyBatteryTitle: "PowerTools をオフにしました",
        notifyBatteryBody: "バッテリー残量が少なくなりました。充電を保護するため通常のスリープに戻しました。",
        adminPromptClamshellOn: "ふたを閉じても続けるには、PowerTools にパスワードが必要です。",
        adminPromptClamshellOff: "Mac の通常のスリープを元に戻すにはパスワードが必要です。",
        adminPromptRecover: "Mac のスリープを無効化したまま PowerTools が終了しました。通常のスリープに戻すにはパスワードを入力してください。",
        adminPromptUpdate: "アップデートをインストールするには PowerTools にパスワードが必要です。",
        adminPromptSudoersInstall: "ふたを閉じたモードをパスワードなしで切り替えられるよう、PowerTools が制限付きルール（pmset disablesleep のみ）を作成します。パスワードが必要なのはこの一度きりです。",
        adminPromptSudoersRemove: "パスワード不要のふたを閉じたモードのルールを PowerTools が削除します。",

        settingsTitle: "PowerTools 設定",
        tabGeneral: "一般",
        tabEnergy: "省エネルギー",
        ...
        advancedResetDescription: "PowerTools に許可したすべてのアクセス権（アクセシビリティ、画面収録、フルディスクアクセスなど）、ログイン項目、ふたを閉じたモードのルールを削除します。最初からやり直すときや、アンインストールの前に便利です。アプリはインストールされたまま残ります。",
        ...
        advancedUninstallDescription: "上記をすべて実行したうえで、環境設定を削除し、PowerTools をゴミ箱に移動して、何も残しません。完了後にアプリは終了します。いつでも再インストールできます。",
        advancedUninstallButton: "PowerTools を完全にアンインストール",
        advancedUninstallConfirmTitle: "PowerTools をアンインストールしますか？",
        advancedUninstallConfirmBody: "PowerTools はアクセス権を消去し、環境設定を削除し、ゴミ箱に移動してから終了します。この操作はアプリからは取り消せませんが、ゴミ箱を空にするまではゴミ箱に残ります。",
        advancedUninstallFailedTitle: "アンインストールを中止しました",
        advancedUninstallFailedBody: "PowerTools が変更したシステム設定（スリープ、ファンの回転数、マウス加速）を元に戻せませんでした。何も削除していません。もう一度試して、パスワードの入力を求められたら許可してください。",
        ...
        keepAwakeAutoStart: "PowerTools起動時にスリープを防ぐ",
        ...
        switcherEnable: "PowerTools のスイッチャーを使う",
        ...
        switcherTakeOverSystemShortcutsCaption: "PowerTools のスイッチャーが動作中の間だけ、対応する macOS のアプリとウインドウのショートカットを無効にします。実行中のすべてのアプリに切り替えられます。",
        ...
        uninstallerFDAHint: "リストで PowerTools をオンにします。表示されない場合は + をクリックし、アプリケーションから PowerTools を選びます。アクセス権はアプリを再度開いた後に有効になります。",
        ...
        homebrewMissingBody: "PowerTools は公式 Homebrew インストーラを Terminal で開けます。Terminal に手順が表示され、必要ならパスワードを求められます。",
        ...
        homebrewShellSetupBody: "Homebrew はインストールされていますが、Terminal がまだ brew コマンドを見つけられない場合があります。PowerTools は設定コマンドを Terminal で開けます。",
        ...
        homebrewTerminalFallback: "この操作では管理者パスワードを求めるために Terminal が必要です。PowerTools はパスワードを取得しません。",
        ...
        updateNotifyTitle: "PowerTools のアップデート",
        updateInstallFailedBody: "アップデートはダウンロードされましたが、適用できませんでした。GitHub のリリースページから最新版をダウンロードし、現在のアプリの上にドラッグして置き換えてください。",
        updateNeedsApplicationsTitle: "PowerTools を「アプリケーション」に移動してください",
        updateNeedsApplicationsBody: "アプリが、ディスクイメージやシステムの一時的な場所など、アップデートできない場所から実行されています。PowerTools を「アプリケーション」フォルダにドラッグし、そこから開いてからもう一度お試しください。",
        ...
        obStart: "PowerTools を開く",
        obStepWelcomeTitle: "PowerTools へようこそ",
        ...
        obStepDoneBody: "PowerTools はすでにあなたの Mac を見守っています。",
        obDoneHint: "画面右上のメニューバーで、PowerTools のアイコンを探してください。",
        obWhatsNewTitle: "このバージョンの新機能",
        obWhatsNewFallback: "このアップデートには最新の修正と改善が含まれています。",
        obLanguageUpdateTitle: "あなたの言語に対応",
        obLanguageUpdateBody: "PowerTools が複数の言語に対応しました。使いたい言語を選んでください。設定でいつでも変更できます。",
        ...
        healthGreetingMorning: "おはよう",
        healthGreetingAfternoon: "こんにちは",
        healthGreetingEvening: "こんばんは",
        healthGreetingHello: "ハロー",
        healthGreetingHi: "やあ",
        healthGreetingHey: "よう",
        healthGreetingHowdy: "どうも",
        healthGreetingGreetings: "ご挨拶",
        healthGreetingNameFormat: "%1$@、%2$@！",
        healthEverythingGood: "特に問題はありません。",
        healthBatteryCriticallyLow: "バッテリー残量が危機的に少なくなっています。",
        healthThermalCritical: "現在Macがスロットリングされています。",
        healthMemoryCritical: "現在メモリの圧迫が高くなっています。",
        healthDiskCriticallyLow: "特に問題はありませんが、ストレージが不足しています。",
        diskInternal: "内蔵",
        diskExternal: "外部",
        diskSelect: "ディスクを選択",
        diskRead: "読み込み",
        ...
        monitorDashboardCardsSection: "ダッシュボードのカード",
        monitorDashboardCardsHint: "ドラッグしてダッシュボードのカードを並べ替え、目のアイコンで各カードを表示/非表示にできます。",
        monitorRefreshingLabel: "更新中…",
        ...
        cleaningNeedsAxBody: "キーボードを安全にロックするには、PowerTools にアクセシビリティのアクセス権が必要です。システム設定で許可して、もう一度お試しください。",
        ...
        donateHeading: "PowerTools の成長を支える",
        donateMessage: "PowerTools は無料で独立したアプリとして、わたしの空き時間に開発しています。金銭的に支援したい場合は、Buy Me a Coffee が開発の継続に直接役立ちます。",
        donateButton: "Buy Me a Coffee で支援する",
        donateThanks: "来てくれてありがとう。🖤",
        supportIntroTitle: "PowerTools の成長を支える",
        supportIntroMessage: "開発を金銭的に支援したい場合は、Buy Me a Coffee が唯一の窓口です。",
        supportIntroStarButton: "GitHub で PowerTools にスターを付ける",
        supportIntroStarMessage: "金銭的な支援は決して必要ではありません。GitHub のスターは、より多くの人が PowerTools を見つける助けになり、開発にも大きな力になります。",
        supportIntroCoffeeButton: "Buy Me a Coffee で支援する",
        supportIntroLaterButton: "今はしない",
        supportIntroDoneButton: "完了",
        discordIntroTitle: "PowerToolsのDiscordコミュニティが始まります",
        discordIntroMessage: "PowerTools コミュニティは新しく、まだ成長の途中です。早い段階から参加して他のユーザーと出会い、アプリを囲む心地よい場所を一緒につくりましょう。",
        ...
        communityIntroFollowButton: "Xで@powertoolsをフォロー",
        homebrewOfficialIntroTitle: "Homebrew 公式カタログに登場",
        homebrewOfficialIntroMessage: "PowerTools を Homebrew 公式カタログから直接インストールできるようになりました。",
        ...
        showMenuBarIconCaption: "PowerTools のアイコンが消えた場合（メニューバーに空きがなくなると macOS がアイコンを隠すことがあり、ノッチのある Mac でよく起こります）、アプリケーションまたは Spotlight から PowerTools を開き直してください。アイコンが再作成され、それでも隠れている場合はこのウインドウが開きます。",
        ...
        menuBarIconManagerHintFormat: "%@ が起動中で、アイコンを隠しセクションにしまっている可能性があります。そこで PowerTools を探すか、%@ で PowerTools を常に表示する設定にしてください。",
        ...
        cleanerNotifDenied: "PowerTools の通知がシステムでオフになっています。",
        cleanerNotifOpenSettings: "通知設定を開く…",
        launchAtLoginNeedsApplications: "ログイン時に開けない場所からアプリが実行されています。PowerToolsをアプリケーションフォルダにドラッグし、そこから開いてもう一度オンにしてください。",
        launchAtLoginNeedsApproval: "ログイン項目は登録されていますが、システム設定ではオフのままです。「システム設定 › 一般 › ログイン項目と機能拡張」を開き、「ログイン時に開く」でPowerToolsをオンにしてください。",
        ...
        mouseAccelerationCaption: "接続したマウスのポインタ加速を無効にします。オフにするか PowerTools を終了すると以前の設定に戻ります。",
