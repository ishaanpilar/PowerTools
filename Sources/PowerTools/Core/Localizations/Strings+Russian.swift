...
extension Strings {
    static let ru = Strings(
        statusIdleTooltip: "PowerTools: обычный сон",
        statusActiveUntil: "PowerTools: активно до",
        statusActiveIndefinite: "PowerTools: активно без срока",
        menuEnableAwake: "Включить режим без сна",
        menuDisableAwake: "Выключить режим без сна",
        menuActivateFor: "Включить на…",
        menuSettings: "Настройки…",
        menuAbout: "О PowerTools",
        menuQuit: "Выйти из PowerTools",
        menuHide: "Скрыть PowerTools",
        ...
        monitorSensorsSection: "Датчики",
        monitorSensorsCaption: "Все датчики температуры, о которых сообщает этот Mac; значения обновляются, пока список открыт. Датчики с пометкой CPU PowerTools использует для температуры процессора.",
        monitorSensorsShow: "Показать все датчики",
        monitorSensorsEmpty: "Этот Mac не сообщает о датчиках температуры.",
        monitorSensorsCountFormat: "Датчики: %d",
        ...
        notifyBatteryTitle: "PowerTools отключён",
        notifyBatteryBody: "Низкий заряд. Обычный сон восстановлен, чтобы сохранить батарею.",
        adminPromptClamshellOn: "PowerTools нужен ваш пароль, чтобы Mac продолжал работать с закрытой крышкой.",
        adminPromptClamshellOff: "PowerTools нужен ваш пароль, чтобы вернуть обычный режим сна Mac.",
        adminPromptRecover: "PowerTools завершился, пока сон Mac был отключён. Введите пароль, чтобы вернуть обычный режим сна.",
        adminPromptUpdate: "PowerTools нужен ваш пароль, чтобы установить обновление.",
        adminPromptSudoersInstall: "PowerTools создаст ограниченное правило (только pmset disablesleep), чтобы переключать режим закрытой крышки без запроса пароля. Пароль понадобится только сейчас.",
        adminPromptSudoersRemove: "PowerTools удалит правило для режима закрытой крышки без пароля.",

        settingsTitle: "Настройки PowerTools",
        tabGeneral: "Основное",
        tabEnergy: "Питание",
        ...
        advancedResetDescription: "Удаляет все разрешения, которые вы дали PowerTools (Универсальный доступ, Запись экрана, Полный доступ к диску и другие), элемент входа и правило закрытой крышки. Полезно, если хотите начать с чистого листа или перед удалением. Приложение останется установленным.",
        ...
        advancedUninstallDescription: "Сделает всё вышеперечисленное, затем удалит настройки и переместит PowerTools в Корзину без остатка. После завершения приложение закроется. Установить его снова можно в любой момент.",
        advancedUninstallButton: "Удалить PowerTools полностью",
        advancedUninstallConfirmTitle: "Удалить PowerTools?",
        advancedUninstallConfirmBody: "PowerTools очистит разрешения, удалит настройки и переместится в Корзину, после чего закроется. Это нельзя отменить из приложения, но файл останется в Корзине, пока вы её не очистите.",
        advancedUninstallFailedTitle: "Удаление остановлено",
        advancedUninstallFailedBody: "PowerTools не смог вернуть изменённую системную настройку: режим сна, скорость вентиляторов или ускорение мыши. Ничего не удалено. Повторите попытку и разрешите запрос пароля, если он появится.",
        ...
        keepAwakeAutoStart: "Не давать уснуть при запуске PowerTools",
        ...
        switcherEnable: "Использовать переключатель PowerTools",
        ...
        switcherTakeOverSystemShortcutsCaption: "Отключает соответствующие сочетания macOS только на время работы переключателя PowerTools. Все запущенные приложения остаются доступны.",
        ...
        uninstallerFDAHint: "Включите PowerTools в списке. Если его там нет, нажмите + и выберите PowerTools из папки «Программы». Доступ начнёт действовать только после повторного запуска приложения.",
        ...
        homebrewMissingBody: "PowerTools может открыть Терминал с официальным установщиком Homebrew. Терминал покажет шаги и при необходимости запросит ваш пароль.",
        ...
        homebrewShellSetupBody: "Homebrew установлен, но Терминал может ещё не видеть команду brew. PowerTools может открыть Терминал с нужной командой настройки.",
        ...
        homebrewTerminalFallback: "Для этой операции нужен Терминал, чтобы запросить пароль администратора. PowerTools не перехватывает пароли.",
        ...
        updateNotifyTitle: "Обновление PowerTools",
        ...
        updateNeedsApplicationsTitle: "Переместите PowerTools в папку «Программы»",
        updateNeedsApplicationsBody: "Приложение запущено из места, которое нельзя обновить, например из образа диска или временного системного расположения. Перетащите PowerTools в папку «Программы», откройте его оттуда и попробуйте снова.",
        ...
        obStart: "Открыть PowerTools",
        obStepWelcomeTitle: "Добро пожаловать в PowerTools",
        ...
        obLanguageUpdateBody: "Теперь PowerTools говорит на нескольких языках. Выберите тот, который хотите использовать; в любой момент его можно сменить в Настройках.",
        ...
        healthGreetingMorning: "Утро",
        healthGreetingAfternoon: "День",
        healthGreetingEvening: "Вечер",
        healthGreetingHello: "Привет",
        healthGreetingHi: "Хай",
        healthGreetingHey: "Эй",
        healthGreetingHowdy: "Здорово",
        healthGreetingGreetings: "Приветствую",
        healthGreetingNameFormat: "%1$@, %2$@!",
        healthEverythingGood: "Всё в порядке.",
        healthBatteryCriticallyLow: "Заряд батареи критически низкий.",
        healthThermalCritical: "Ваш Mac сейчас троттлится.",
        healthMemoryCritical: "Сейчас высокое давление на память.",
        healthDiskCriticallyLow: "Всё в порядке, кроме места на диске.",
        ...
        monitorDashboardCardsSection: "Карточки панели",
        monitorDashboardCardsHint: "Перетаскивайте, чтобы менять порядок карточек панели, и используйте глаз, чтобы показывать или скрывать каждую из них.",
        monitorRefreshingLabel: "Обновление…",
        ...
        cleaningNeedsAxBody: "Чтобы безопасно блокировать клавиатуру, PowerTools нужен доступ к Универсальному доступу. Выдайте его в Системных настройках и попробуйте снова.",
        ...
        donateHeading: "Помогите PowerTools развиваться",
        donateMessage: "PowerTools бесплатен, независим и создаётся в моё свободное время. Если вы хотите помочь финансово, Buy Me a Coffee напрямую поддерживает дальнейшую разработку.",
        donateButton: "Поддержать через Buy Me a Coffee",
        donateThanks: "Спасибо, что вы здесь. 🖤",
        supportIntroTitle: "Помогите PowerTools развиваться",
        supportIntroMessage: "Если вы хотите финансово поддержать разработку, сделать это можно только через Buy Me a Coffee.",
        supportIntroStarButton: "Поставить PowerTools звезду на GitHub",
        supportIntroStarMessage: "Финансовая поддержка совсем не обязательна. Звезда на GitHub помогает большему числу людей найти PowerTools и действительно влияет на его развитие.",
        supportIntroCoffeeButton: "Поддержать через Buy Me a Coffee",
        supportIntroLaterButton: "Не сейчас",
        supportIntroDoneButton: "Готово",
        discordIntroTitle: "Сообщество PowerTools в Discord только начинает расти",
        discordIntroMessage: "Сообщество PowerTools новое и всё ещё формируется. Присоединяйтесь сейчас, знакомьтесь с другими пользователями и помогите создать дружелюбное пространство вокруг приложения.",
        ...
        communityIntroFollowButton: "Подписаться на @powertools в X",
        homebrewOfficialIntroTitle: "Теперь в официальном каталоге Homebrew",
        homebrewOfficialIntroMessage: "Теперь PowerTools можно установить прямо из официального каталога Homebrew.",
        ...
        showMenuBarIconCaption: "Если значок PowerTools исчезнет (macOS может скрывать значки строки меню, когда в ней не хватает места, что часто бывает на Mac с вырезом), откройте PowerTools снова из папки «Программы» или через Spotlight: это пересоздаст значок и, если он всё ещё скрыт, откроет это окно.",
        ...
        menuBarIconManagerHintFormat: "%@ запущен и, возможно, держит значок в своей скрытой секции. Поищите PowerTools там или настройте %@ всегда показывать PowerTools.",
        ...
        cleanerNotifDenied: "Уведомления PowerTools отключены в системе.",
        cleanerNotifOpenSettings: "Открыть настройки уведомлений…",
        launchAtLoginNeedsApplications: "Приложение запущено из места, из которого нельзя открываться при входе. Перетащите PowerTools в папку «Программы», откройте его оттуда и включите параметр снова.",
        launchAtLoginNeedsApproval: "Объект входа зарегистрирован, но в Системных настройках он выключен. Откройте «Системные настройки › Основные › Объекты входа и расширения» и включите PowerTools в разделе «Открывать при входе».",
        ...
        mouseAccelerationCaption: "Отключает ускорение указателя для подключённых мышей. Прежняя настройка вернётся после выключения функции или выхода из PowerTools.",
