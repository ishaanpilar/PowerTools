...
extension Strings {
    static let es = Strings(
        statusIdleTooltip: "PowerTools: reposo normal",
        statusActiveUntil: "PowerTools: activo hasta",
        statusActiveIndefinite: "PowerTools: activo indefinidamente",
        menuEnableAwake: "Activar mantener activo",
        menuDisableAwake: "Desactivar mantener activo",
        menuActivateFor: "Activar durante…",
        menuSettings: "Ajustes…",
        menuAbout: "Acerca de PowerTools",
        menuQuit: "Salir de PowerTools",
        menuHide: "Ocultar PowerTools",
        ...
        cpuSpeedLimitLabel: "Límite de CPU",
        monitorSensorsSection: "Sensores",
        monitorSensorsCaption: "Todos los sensores de temperatura que informa este Mac, leídos en vivo mientras la lista está abierta. Los marcados como CPU son los que PowerTools usa para la temperatura de la CPU.",
        monitorSensorsShow: "Mostrar todos los sensores",
        monitorSensorsEmpty: "Este Mac no informa sensores de temperatura.",
        ...
        notifyBatteryTitle: "PowerTools desactivado",
        notifyBatteryBody: "Batería baja. Se restauró el reposo normal para proteger la carga.",
        adminPromptClamshellOn: "PowerTools necesita tu contraseña para seguir con la tapa cerrada.",
        adminPromptClamshellOff: "PowerTools necesita tu contraseña para restaurar el reposo normal del Mac.",
        adminPromptRecover: "PowerTools se cerró mientras el reposo del Mac estaba desactivado. Introduce la contraseña para restaurar el reposo normal.",
        adminPromptUpdate: "PowerTools necesita tu contraseña para instalar la actualización.",
        adminPromptSudoersInstall: "PowerTools creará una regla restringida (solo pmset disablesleep) para alternar el modo de tapa cerrada sin pedir contraseña. Esta es la única vez que se necesita la contraseña.",
        adminPromptSudoersRemove: "PowerTools eliminará la regla de tapa cerrada sin contraseña.",

        settingsTitle: "Ajustes de PowerTools",
        tabGeneral: "General",
        tabEnergy: "Energía",
        ...
        advancedResetDescription: "Elimina todos los permisos que concediste a PowerTools (Accesibilidad, Grabación de pantalla, Acceso total al disco y otros), el ítem de inicio de sesión y la regla de tapa cerrada. Útil para empezar de cero o antes de desinstalar. La app sigue instalada.",
        ...
        advancedUninstallDescription: "Hace todo lo anterior y, además, elimina las preferencias y mueve PowerTools a la Papelera, sin dejar rastro. La app se cierra al terminar. Puedes reinstalarla cuando quieras.",
        advancedUninstallButton: "Desinstalar PowerTools por completo",
        advancedUninstallConfirmTitle: "¿Desinstalar PowerTools?",
        advancedUninstallConfirmBody: "PowerTools borrará sus permisos, eliminará sus preferencias y se moverá a la Papelera; después se cerrará. Esto no se puede deshacer desde la app, pero permanece en la Papelera hasta que la vacíes.",
        advancedUninstallFailedTitle: "La desinstalación se detuvo",
        advancedUninstallFailedBody: "PowerTools no pudo restaurar un ajuste del sistema que había cambiado: la suspensión, la velocidad de los ventiladores o la aceleración del ratón. No se eliminó nada. Inténtalo de nuevo y permite la solicitud de contraseña si aparece.",
        ...
        keepAwakeAutoStart: "Mantener activo al abrir PowerTools",
        ...
        switcherEnable: "Usar el selector de PowerTools",
        ...
        switcherTakeOverSystemShortcutsCaption: "Desactiva los atajos correspondientes de macOS solo mientras el selector de PowerTools está activo. Todas las apps abiertas siguen accesibles.",
        ...
        uninstallerFDAHint: "Activa PowerTools en la lista. Si no aparece, haz clic en + y elige PowerTools en Aplicaciones. El acceso solo se aplica después de volver a abrir la app.",
        ...
        homebrewMissingBody: "PowerTools puede abrir Terminal con el instalador oficial de Homebrew. Terminal muestra los pasos y pide tu contraseña si hace falta.",
        ...
        homebrewShellSetupBody: "Homebrew está instalado, pero Terminal quizá aún no encuentre el comando brew. PowerTools puede abrir Terminal con el comando de configuración.",
        ...
        homebrewTerminalFallback: "Esta operación necesita Terminal para pedir la contraseña de administrador. PowerTools no captura contraseñas.",
        ...
        updateNotifyTitle: "Actualización de PowerTools",
        ...
        updateNeedsApplicationsTitle: "Mueve PowerTools a Aplicaciones",
        updateNeedsApplicationsBody: "La app se está ejecutando desde un lugar que no se puede actualizar, como la imagen de disco o una ubicación temporal del sistema. Arrastra PowerTools a la carpeta Aplicaciones, ábrela desde ahí y vuelve a intentarlo.",
        ...
        obStart: "Abrir PowerTools",
        obStepWelcomeTitle: "Te damos la bienvenida a PowerTools",
        ...
        obLanguageUpdateBody: "PowerTools ahora habla varios idiomas. Elige el que quieras usar; puedes cambiarlo cuando quieras en Ajustes.",
        ...
        diskCriticallyLow: "Almacenamiento críticamente bajo",
        diskReclaimableFormat: "Se pueden liberar hasta %@",
        diskOpenCleaner: "Abrir Cleaner",
        healthGreetingMorning: "Buenos días",
        healthGreetingAfternoon: "Buenas tardes",
        healthGreetingEvening: "Buenas noches",
        healthGreetingHello: "Hola",
        healthGreetingHi: "Ey",
        healthGreetingHey: "Oye",
        healthGreetingHowdy: "Qué tal",
        healthGreetingGreetings: "Saludos",
        healthGreetingNameFormat: "%1$@, %2$@!",
        healthEverythingGood: "Todo está bien.",
        healthBatteryCriticallyLow: "Tu batería está críticamente baja.",
        healthThermalCritical: "Tu Mac se está limitando por temperatura.",
        healthMemoryCritical: "La presión de memoria es alta ahora mismo.",
        healthDiskCriticallyLow: "Todo está bien, excepto el almacenamiento.",
        ...
        monitorRefreshingLabel: "Actualizando…",
        ...
        cleaningNeedsAxBody: "Para bloquear el teclado de forma segura, PowerTools necesita el permiso de Accesibilidad. Concédelo en Ajustes del Sistema e inténtalo de nuevo.",
        ...
        donateHeading: "Ayuda a que PowerTools siga creciendo",
        donateMessage: "PowerTools es gratis, independiente y lo desarrollo en mi tiempo libre. Si quieres contribuir económicamente, Buy Me a Coffee ayuda directamente a mantener el desarrollo en marcha.",
        donateButton: "Apoyar en Buy Me a Coffee",
        donateThanks: "Gracias por estar aquí. 🖤",
        supportIntroTitle: "Ayuda a que PowerTools siga creciendo",
        supportIntroMessage: "Si quieres apoyar económicamente el desarrollo, Buy Me a Coffee es el único lugar para hacerlo.",
        supportIntroStarButton: "Dar una estrella a PowerTools en GitHub",
        supportIntroStarMessage: "Nunca se espera apoyo económico. Una estrella en GitHub ayuda a que más personas descubran PowerTools y marca una diferencia real en su desarrollo.",
        supportIntroCoffeeButton: "Apoyar en Buy Me a Coffee",
        supportIntroLaterButton: "Ahora no",
        supportIntroDoneButton: "Listo",
        discordIntroTitle: "La comunidad de PowerTools en Discord acaba de empezar",
        discordIntroMessage: "La comunidad de PowerTools es nueva y todavía está tomando forma. Únete desde el principio para conocer a otros usuarios y ayudar a crear un espacio acogedor alrededor de la app.",
        ...
        communityIntroFollowButton: "Seguir a @powertools en X",
        homebrewOfficialIntroTitle: "Ahora en el catálogo oficial de Homebrew",
        homebrewOfficialIntroMessage: "PowerTools ya se puede instalar directamente desde el catálogo oficial de Homebrew.",
        ...
        showMenuBarIconCaption: "Si el icono de PowerTools desaparece (macOS puede ocultar iconos de la barra de menús cuando se queda sin espacio, algo habitual en Macs con notch), vuelve a abrir PowerTools desde Aplicaciones o Spotlight: eso recrea el icono y, si sigue oculto, abre esta ventana.",
        ...
        menuBarIconManagerHintFormat: "%@ está abierto y puede estar guardando el icono en su sección oculta. Busca PowerTools ahí, o configura %@ para mostrar siempre PowerTools.",
        ...
        cleanerNotifDenied: "Las notificaciones de PowerTools están desactivadas en el sistema.",
        cleanerNotifOpenSettings: "Abrir ajustes de notificaciones…",
        launchAtLoginNeedsApplications: "La app se está ejecutando desde un lugar que no permite abrirse al iniciar sesión. Arrastra PowerTools a la carpeta Aplicaciones, ábrelo desde ahí y actívalo de nuevo.",
        launchAtLoginNeedsApproval: "El ítem de inicio está registrado, pero sigue desactivado en Ajustes del Sistema. Abre Ajustes del Sistema › General › Ítems de inicio y extensiones y activa PowerTools en “Abrir al iniciar sesión”.",
        ...
        mouseAccelerationCaption: "Elimina la aceleración del puntero para los ratones conectados. El ajuste anterior vuelve al desactivarlo o salir de PowerTools.",
