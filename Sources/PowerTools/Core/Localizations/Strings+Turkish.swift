...
extension Strings {
    static let tr = Strings(
        statusIdleTooltip: "PowerTools: normal uyku",
        statusActiveUntil: "PowerTools: şu zamana kadar uyanık",
        statusActiveIndefinite: "PowerTools: süresiz uyanık",
        ...
        menuAbout: "PowerTools Hakkında",
        menuQuit: "PowerTools’ten Çık",
        menuHide: "PowerTools’i Gizle",
        ...
        monitorSensorsSection: "Sensörler",
        monitorSensorsCaption: "Bu Mac’in bildirdiği tüm sıcaklık sensörleri; liste açıkken canlı okunur. CPU olarak işaretlenenler, PowerTools’un CPU sıcaklığı için kullandığı sensörlerdir.",
        monitorSensorsShow: "Tüm sensörleri göster",
        monitorSensorsEmpty: "Bu Mac sıcaklık sensörü bildirmiyor.",
        monitorSensorsCountFormat: "Sensörler: %d",
        ...
        notifyBatteryTitle: "PowerTools devre dışı",
        notifyBatteryBody: "Pil düşük. Şarjı korumak için normal uyku geri yüklendi.",
        adminPromptClamshellOn: "PowerTools’in, Mac’i kapak kapalıyken çalıştırmak için parolana ihtiyacı var.",
        adminPromptClamshellOff: "PowerTools’in, Mac’in normal uykusunu geri yüklemek için parolana ihtiyacı var.",
        adminPromptRecover: "Mac’in uykusu kapalıyken PowerTools kapandı. Normal uykuyu geri yüklemek için parolayı gir.",
        adminPromptUpdate: "PowerTools güncellemeyi yüklemek için parolanıza ihtiyaç duyuyor.",
        adminPromptSudoersInstall: "PowerTools, parola sormadan kapak kapalı modunu açıp kapatmak için kısıtlı bir kural oluşturacak (yalnızca pmset disablesleep). Parolanın gerektiği tek zaman bu.",
        adminPromptSudoersRemove: "PowerTools, parolasız kapak kapalı kuralını kaldıracak.",

        settingsTitle: "PowerTools Ayarları",
        tabGeneral: "Genel",
        tabEnergy: "Enerji",
        ...
        advancedResetDescription: "PowerTools’e verdiğin tüm izinleri (Erişilebilirlik, Ekran Kaydı, Tam Disk Erişimi ve diğerleri), oturum açma öğesini ve kapak kapalı kuralını kaldırır. Sıfırdan başlamak veya kaldırmadan önce temizlemek için kullanışlıdır. Uygulama yüklü kalır.",
        ...
        advancedUninstallDescription: "Yukarıdakilerin hepsini yapar, ardından tercihleri kaldırır ve PowerTools’i Çöp Sepeti’ne taşır; geride hiçbir şey bırakmaz. İş bitince uygulama kapanır. İstediğin zaman yeniden yükleyebilirsin.",
        advancedUninstallButton: "PowerTools’i tamamen kaldır",
        advancedUninstallConfirmTitle: "PowerTools kaldırılsın mı?",
        advancedUninstallConfirmBody: "PowerTools izinlerini temizleyecek, tercihlerini kaldıracak ve Çöp Sepeti’ne taşınıp kapanacak. Bu işlem uygulama içinden geri alınamaz, ama Çöp Sepeti’ni boşaltana kadar orada kalır.",
        advancedUninstallFailedTitle: "Kaldırma durduruldu",
        advancedUninstallFailedBody: "PowerTools değiştirdiği bir sistem ayarını geri alamadı: uyku, fan hızı veya fare hızlandırması. Hiçbir şey silinmedi. Yeniden deneyin ve parola istenirse izin verin.",
        ...
        keepAwakeAutoStart: "PowerTools açılınca uyanık tut",
        ...
        switcherEnable: "PowerTools değiştiricisini kullan",
        ...
        switcherTakeOverSystemShortcutsCaption: "Eşleşen macOS uygulama ve pencere kısayollarını yalnızca PowerTools değiştiricisi etkinken kapatır. Çalışan tüm uygulamalara erişim korunur.",
        ...
        uninstallerFDAHint: "Listede PowerTools’i aç. Orada yoksa + düğmesine tıkla ve Uygulamalar’dan PowerTools’i seç. Erişim yalnızca uygulamayı yeniden açtıktan sonra geçerli olur.",
        ...
        homebrewMissingBody: "PowerTools, resmi Homebrew yükleyicisiyle Terminal’i açabilir. Terminal adımları gösterir ve gerekirse parolanı ister.",
        ...
        homebrewShellSetupBody: "Homebrew yüklü, ancak Terminal brew komutunu henüz bulamayabilir. PowerTools, kurulum komutuyla Terminal’i açabilir.",
        ...
        homebrewTerminalFallback: "Bu işlem, yönetici parolasını istemek için Terminal’e ihtiyaç duyar. PowerTools parolaları yakalamaz.",
        ...
        updateNotifyTitle: "PowerTools güncellemesi",
        ...
        updateNeedsApplicationsTitle: "PowerTools’i Uygulamalar klasörüne taşıyın",
        updateNeedsApplicationsBody: "Uygulama, disk görüntüsü veya geçici bir sistem konumu gibi güncellenemeyen bir yerden çalışıyor. PowerTools’i Uygulamalar klasörüne sürükleyin, oradan açın ve yeniden deneyin.",
        ...
        obStart: "PowerTools’i aç",
        obStepWelcomeTitle: "PowerTools’e hoş geldin",
        ...
        obLanguageUpdateBody: "PowerTools artık birçok dil konuşuyor. Kullanmak istediğin dili seç; bunu istediğin zaman Ayarlar’dan değiştirebilirsin.",
        ...
        healthGreetingMorning: "Günaydın",
        healthGreetingAfternoon: "İyi günler",
        healthGreetingEvening: "İyi akşamlar",
        healthGreetingHello: "Merhaba",
        healthGreetingHi: "Selam",
        healthGreetingHey: "Hey",
        healthGreetingHowdy: "Naber",
        healthGreetingGreetings: "Selamlar",
        healthGreetingNameFormat: "%1$@, %2$@!",
        healthEverythingGood: "Her şey yolunda.",
        healthBatteryCriticallyLow: "Bataryan kritik derecede düşük.",
        healthThermalCritical: "Mac’in şu anda kısıtlanıyor.",
        healthMemoryCritical: "Şu anda bellek baskısı yüksek.",
        healthDiskCriticallyLow: "Her şey yolunda, depolama alanı hariç.",
        diskInternal: "Dahili",
        diskExternal: "Harici",
        diskSelect: "Disk seç",
        diskRead: "Okuma",
        ...
        monitorRefreshingLabel: "Yenileniyor…",
        ...
        cleaningNeedsAxBody: "Klavyeyi güvenle kilitlemek için PowerTools’in Erişilebilirlik iznine ihtiyacı var. Sistem Ayarları’ndan izin ver ve tekrar dene.",
        ...
        donateHeading: "PowerTools’in gelişmesine destek ol",
        donateMessage: "PowerTools ücretsiz, bağımsız ve boş zamanlarımda geliştiriliyor. Maddi destek olmak istersen Buy Me a Coffee, geliştirmeyi sürdürmeme doğrudan yardımcı olur.",
        donateButton: "Buy Me a Coffee ile destek ol",
        donateThanks: "Burada olduğun için teşekkürler. 🖤",
        supportIntroTitle: "PowerTools’in gelişmesine destek ol",
        supportIntroMessage: "Geliştirmeye maddi destek olmak istersen bunu yapabileceğin tek yer Buy Me a Coffee.",
        supportIntroStarButton: "GitHub’da PowerTools’e yıldız ver",
        supportIntroStarMessage: "Maddi destek asla beklenmez. GitHub’da verilen bir yıldız, daha fazla kişinin PowerTools’i keşfetmesine yardımcı olur ve geliştirilmesinde gerçek bir fark yaratır.",
        supportIntroCoffeeButton: "Buy Me a Coffee ile destek ol",
        supportIntroLaterButton: "Şimdi değil",
        supportIntroDoneButton: "Tamam",
        discordIntroTitle: "PowerTools Discord topluluğu daha yeni başlıyor",
        discordIntroMessage: "PowerTools topluluğu yeni ve hâlâ şekilleniyor. Diğer kullanıcılarla tanışmak ve uygulamanın etrafında sıcak bir alan oluşturmaya yardım etmek için erkenden katıl.",
        ...
        communityIntroFollowButton: "X’te @powertools’i takip et",
        homebrewOfficialIntroTitle: "Artık resmî Homebrew kataloğunda",
        homebrewOfficialIntroMessage: "PowerTools artık doğrudan resmî Homebrew kataloğundan kurulabilir.",
        ...
        showMenuBarIconCaption: "PowerTools simgesi kaybolursa (macOS, çubukta yer kalmadığında menü çubuğu simgelerini gizleyebilir; çentikli Mac’lerde yaygındır), PowerTools’i Uygulamalar’dan veya Spotlight’tan yeniden aç: bu simgeyi yeniden oluşturur ve hâlâ gizliyse bu pencereyi açar.",
        ...
        menuBarIconManagerHintFormat: "%@ açık ve simgeyi gizli bölümünde tutuyor olabilir. PowerTools’i orada arayın veya %@ uygulamasını PowerTools’i her zaman gösterecek şekilde ayarlayın.",
        ...
        cleanerNotifDenied: "PowerTools bildirimleri sistemde kapalı.",
        cleanerNotifOpenSettings: "Bildirim ayarlarını aç…",
        launchAtLoginNeedsApplications: "Uygulama, oturum açılırken açılmaya izin vermeyen bir konumdan çalışıyor. PowerTools’i Uygulamalar klasörüne sürükleyin, oradan açın ve bu seçeneği yeniden açın.",
        launchAtLoginNeedsApproval: "Giriş ögesi kayıtlı, ancak Sistem Ayarları’nda hâlâ kapalı. Sistem Ayarları › Genel › Giriş Ögeleri ve Uzantılar’ı açın ve “Oturum açılırken aç” altında PowerTools’i açın.",
        ...
        mouseAccelerationCaption: "Bağlı farelerde işaretçi hızlandırmasını kaldırır. Seçenek kapatıldığında veya PowerTools’ten çıkıldığında önceki ayar geri yüklenir.",
