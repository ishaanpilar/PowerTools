...
extension MouseButtonFeatureStrings {
    ...
    static let ptBR = MouseButtonFeatureStrings(
        ...
        captureBlind: "O PowerTools não consegue observar o mouse agora.",
    ...
    static let tr = MouseButtonFeatureStrings(
        ...
        captureBlind: "PowerTools şu anda fareyi izleyemiyor.",
    ...
    static let ru = MouseButtonFeatureStrings(
        ...
        captureBlind: "PowerTools сейчас не может отслеживать мышь.",
    ...
    static let es = MouseButtonFeatureStrings(
        ...
        captureCancel: "Cancelar",
        captureBlind: "PowerTools no puede observar el ratón ahora mismo.",
    ...
    static let de = MouseButtonFeatureStrings(
        ...
        captureBlind: "PowerTools kann die Maus gerade nicht beobachten.",
    ...
    static let fr = MouseButtonFeatureStrings(
        ...
        captureBlind: "PowerTools ne peut pas observer la souris pour le moment.",
    ...
    static let it = MouseButtonFeatureStrings(
        ...
        captureBlind: "PowerTools al momento non riesce a osservare il mouse.",
    ...
    static let ja = MouseButtonFeatureStrings(
        ...
        captureCancel: "キャンセル",
        captureBlind: "PowerToolsは今マウスを監視できません。",
    ...
    static let ko = MouseButtonFeatureStrings(
        ...
        captureCancel: "취소",
        captureBlind: "PowerTools가 지금은 마우스를 지켜볼 수 없습니다.",
    ...
    static let zhHans = MouseButtonFeatureStrings(
        ...
        captureCancel: "取消",
        captureBlind: "PowerTools 目前无法监视鼠标。",
    ...
    static let zhTW = MouseButtonFeatureStrings(
        ...
        captureCancel: "取消",
        captureBlind: "PowerTools 目前無法監看滑鼠。",
