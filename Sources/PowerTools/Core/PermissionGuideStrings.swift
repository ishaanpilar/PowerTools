...
extension PermissionGuideStrings {
    static let ko = PermissionGuideStrings(
        ...
        stepToggle: "그 목록에서 PowerTools를 켜세요.",
...
extension PermissionGuideStrings {
    ...
    static let ptBR = PermissionGuideStrings(
        ...
        stepToggle: "Ligue o PowerTools nessa lista.",
    ...
    static let tr = PermissionGuideStrings(
        ...
        stepToggle: "O listede PowerTools’i açın.",
    ...
    static let ru = PermissionGuideStrings(
        ...
        stepToggle: "Включите PowerTools в этом списке.",
    ...
    static let es = PermissionGuideStrings(
        ...
        stepToggle: "Activa PowerTools en esa lista.",
    ...
    static let de = PermissionGuideStrings(
        ...
        stepToggle: "Schalte PowerTools in dieser Liste ein.",
    ...
    static let fr = PermissionGuideStrings(
        ...
        stepToggle: "Activez PowerTools dans cette liste.",
    ...
    static let it = PermissionGuideStrings(
        ...
        stepToggle: "Attiva PowerTools in quell’elenco.",
    ...
    static let ja = PermissionGuideStrings(
        ...
        stepToggle: "そのリストでPowerToolsをオンにしてください。",
