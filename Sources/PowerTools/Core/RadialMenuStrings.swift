...
extension RadialMenuFeatureStrings {
    static let enUS = RadialMenuFeatureStrings(
        ...
        buttonTestSeen: "PowerTools AI sees this button",
        buttonTestOther: "That was a different button",
        buttonTestBlind: "PowerTools AI cannot watch the mouse right now",
    ...
    static let ptBR = RadialMenuFeatureStrings(
        ...
        kindTool: "Ferramenta do PowerTools",
        ...
        buttonTestSeen: "O PowerTools enxerga esse botão",
        buttonTestOther: "Esse foi outro botão",
        buttonTestBlind: "O PowerTools não consegue observar o mouse agora",
    ...
    static let tr = RadialMenuFeatureStrings(
        ...
        buttonTestSeen: "PowerTools bu düğmeyi görüyor",
        buttonTestOther: "Bu başka bir düğmeydi",
        buttonTestBlind: "PowerTools şu anda fareyi izleyemiyor",
    ...
    static let ru = RadialMenuFeatureStrings(
        ...
        kindTool: "Инструмент PowerTools",
        ...
        buttonTestSeen: "PowerTools видит эту кнопку",
        buttonTestOther: "Это была другая кнопка",
        buttonTestBlind: "PowerTools сейчас не может следить за мышью",
    ...
    static let es = RadialMenuFeatureStrings(
        ...
        kindTool: "Herramienta de PowerTools",
        ...
        buttonTestSeen: "PowerTools ve este botón",
        buttonTestOther: "Ese fue otro botón",
        buttonTestBlind: "PowerTools no puede observar el ratón ahora",
    ...
    static let de = RadialMenuFeatureStrings(
        ...
        buttonTestSeen: "PowerTools sieht diese Taste",
        buttonTestOther: "Das war eine andere Taste",
        buttonTestBlind: "PowerTools kann die Maus gerade nicht beobachten",
    ...
    static let fr = RadialMenuFeatureStrings(
        ...
        buttonTestSeen: "PowerTools voit ce bouton",
        buttonTestOther: "C’était un autre bouton",
        buttonTestBlind: "PowerTools ne peut pas observer la souris pour le moment",
    ...
    static let it = RadialMenuFeatureStrings(
        ...
        buttonTestSeen: "PowerTools vede questo pulsante",
        buttonTestOther: "Quello era un altro pulsante",
        buttonTestBlind: "PowerTools non riesce a osservare il mouse in questo momento",
    ...
    static let ja = RadialMenuFeatureStrings(
        ...
        buttonTestSeen: "PowerTools はこのボタンを認識しています",
        buttonTestOther: "いまのは別のボタンです",
        buttonTestBlind: "PowerTools はいまマウスを見られません",
    ...
    static let ko = RadialMenuFeatureStrings(
        ...
        buttonTestSeen: "PowerTools가 이 버튼을 인식합니다",
        buttonTestOther: "방금 것은 다른 버튼입니다",
        buttonTestBlind: "지금은 PowerTools가 마우스를 살펴볼 수 없습니다",
    ...
    static let zhHans = RadialMenuFeatureStrings(
        ...
        buttonTestSeen: "PowerTools 能看到这个按键",
        buttonTestOther: "刚才是另一个按键",
        buttonTestBlind: "PowerTools 现在无法观察鼠标",
    ...
    static let zhTW = RadialMenuFeatureStrings(
        ...
        buttonTestSeen: "PowerTools 看得到這個按鍵",
        buttonTestOther: "剛才是另一個按鍵",
        buttonTestBlind: "PowerTools 目前無法觀察滑鼠",
