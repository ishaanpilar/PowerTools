...
extension ScreenshotFeatureStrings {
    static let enUS = ScreenshotFeatureStrings(
        ...
        sharePrivacyData: "PowerTools sends only the rendered image and the expiration you choose. It does not send your name, account, device identifier or MAC address. On this Mac, it keeps only the link, expiration and private deletion token while the link is active.",
        ...
        hidePowerToolsWindowsToggle: "Hide PowerTools windows",
