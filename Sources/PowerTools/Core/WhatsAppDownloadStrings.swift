...
extension WhatsAppDownloadStrings {
    static let enUS = WhatsAppDownloadStrings(
        ...
        accessDenied: "PowerTools cannot access Downloads. Allow it in Files & Folders.",
        ...
        localNote: "Only local file metadata is inspected. PowerTools never reads chats or file contents.",
