...
/// activation this app holds, and PowerTools (`LSUIElement`, non-activating
...
enum ActivationHandoff {
    ...
    /// Past that, an activation of PowerTools is the user opening one of its
    ...
    /// Whether the activation of PowerTools being reported right now is the one
