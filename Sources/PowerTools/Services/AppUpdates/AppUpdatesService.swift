...
final class AppUpdatesService: ObservableObject {
    ...
    private let workQueue = DispatchQueue(label: "com.powertools.appupdates", qos: .utility)
    ...
    private static func isOwnBundle(_ bundleID: String) -> Bool {
        bundleID == Bundle.main.bundleIdentifier || bundleID.hasPrefix("com.powertools")
    }

    private static let ownPackageTokens: Set<String> = ["powertools", "powertools@beta", "powertools-beta"]
