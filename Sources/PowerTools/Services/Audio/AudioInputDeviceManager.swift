...
/// Keeps PowerTools's preferred microphone in sync with macOS' global input.
...
final class AudioInputDeviceManager: ObservableObject {
    ...
    private let halQueue = DispatchQueue(label: "com.powertools.utils.audioinput.hal", qos: .userInitiated)
