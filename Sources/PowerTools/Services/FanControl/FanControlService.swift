...
final class FanControlService: ObservableObject {
    ...
    private let probeQueue = DispatchQueue(label: "com.powertools.fan-control.probe",
                                           qos: .utility)
    ...
    private static var helperVersion: String {
        Bundle.main.object(forInfoDictionaryKey: "PowerToolsFanControlHelperVersion") as? String
