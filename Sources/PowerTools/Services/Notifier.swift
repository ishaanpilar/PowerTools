...
enum Notifier {
    static let whatsAppOrganizerUndoActionIdentifier =
        "com.powertools.notification.whatsapp-organizer.undo"
    private static let whatsAppOrganizerTransactionKey =
        "com.powertools.notification.whatsapp-organizer.transaction"
    private static let whatsAppOrganizerCategoryIdentifier =
        "com.powertools.notification.whatsapp-organizer"
    private static let log = Logger(subsystem: Bundle.main.bundleIdentifier ?? "powertools",
