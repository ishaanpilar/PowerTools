...
final class ScreenshotSelectionController {
    ...
    private var hidePowerToolsWindows: Bool
    ...
    init(freeze: Bool,
         includePointer: Bool,
         showLastRegion: Bool,
         hidePowerToolsWindows: Bool = true,
        ...
        self.hidePowerToolsWindows = hidePowerToolsWindows
        ...
        self.capturePolicy = ScreenshotSupport.UnifiedCapturePolicy(
            ...
            hidePowerToolsWindows: hidePowerToolsWindows,
        ...
        if freeze {
            Task { @MainActor [weak self] in
                ...
                let images = await ScreenshotCaptureEngine.captureAllDisplays(
                    ...
                    hidePowerToolsWindows: self.hidePowerToolsWindows,
    ...
    private func screenCaptureToolDidChange() {
        if let activeTool {
            ...
            let nextPolicy = ScreenshotSupport.unifiedCapturePolicy(
                ...
                screenshotHidePowerToolsWindows: defaults.bool(
                    forKey: DefaultsKey.screenshotHidePowerToolsWindows))
    ...
    private func adoptCapturePolicy(_ policy: ScreenshotSupport.UnifiedCapturePolicy) {
        ...
        hidePowerToolsWindows = policy.hidePowerToolsWindows
        sourceGeneration += 1
    ...
    private func loadLiveLoupeImages() {
        let hideWindows = hidePowerToolsWindows
        let excludedIDs = captureExcludedWindowIDs
        Task { @MainActor [weak self] in
            let images = await ScreenshotCaptureEngine.captureAllDisplays(
                includePointer: false,
                hidePowerToolsWindows: hideWindows,
