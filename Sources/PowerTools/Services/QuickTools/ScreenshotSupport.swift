...
enum ScreenshotSupport {
    ...
    struct UnifiedCapturePolicy: Equatable {
        ...
        let hidePowerToolsWindows: Bool
        ...
        func sharesSource(with other: UnifiedCapturePolicy) -> Bool {
            freeze == other.freeze
                ...
                && hidePowerToolsWindows == other.hidePowerToolsWindows
        }
    }
