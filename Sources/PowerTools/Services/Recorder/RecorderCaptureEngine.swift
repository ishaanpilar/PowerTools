...
final class RecorderCaptureEngine: NSObject {
    ...
    private let queue = DispatchQueue(label: "com.powertools.recorder.capture",
                                      qos: .userInitiated)
    ...
    /// Builds the filter and starts the stream. Existing ordinary PowerTools
...
final class RecorderMicrophoneCapture: NSObject,
    ...
    private let queue = DispatchQueue(label: "com.powertools.recorder.microphone",
                                      qos: .userInitiated)
