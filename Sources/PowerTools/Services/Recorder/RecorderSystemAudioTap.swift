...
final class RecorderSystemAudioTap: @unchecked Sendable {
    ...
    private static let teardownQueue = DispatchQueue(label: "com.powertools.recorder.systemaudio.teardown",
                                                     qos: .utility)
    ...
    static func make() async -> RecorderSystemAudioTap? {
        ...
        let queue = DispatchQueue(label: "com.powertools.recorder.systemaudio",
                                  qos: .userInitiated)
    ...
    private init?(queue: DispatchQueue) {
        ...
        description.name = "PowerTools Recorder"
    ...
    private func buildPipeline() {
        ...
        let aggregate: [String: Any] = [
            kAudioAggregateDeviceNameKey: "PowerTools Recorder",
