...
enum SelfUninstall {
    private static var bundleID: String { Bundle.main.bundleIdentifier ?? "com.powertools.utils" }
    ...
    /// bundle to the Trash and quits. Used by "Uninstall PowerTools completely".
    ...
    private static func trashOwnBundleAndQuit() {
        ...
        let scriptURL = FileManager.default.temporaryDirectory
            .appendingPathComponent("powertools-uninstall-\(pid)-\(UUID().uuidString).sh")
        do {
