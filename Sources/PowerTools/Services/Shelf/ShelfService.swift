...
final class ShelfService: ObservableObject {
    ...
    private let tempDir: URL = {
        let id = Bundle.main.bundleIdentifier ?? "com.powertools.utils"
        let dir = FileManager.default.temporaryDirectory
            .appendingPathComponent("PowerToolsShelf", isDirectory: true)
    ...
    private static let persistQueue = DispatchQueue(label: "com.powertools.utils.shelf-persist",
                                                    qos: .utility)
