...
final class WindowUseTracker {
    ...
    @objc private func appActivated(_ note: Notification) {
        ...
        // self-activating on the way out; ranking it would put PowerTools ahead
        // of the app the user left. Every other activation of PowerTools, the
    ...
    private func startWatcher() {
        let thread = lifecycleLock.withLock { () -> Thread? in
            ...
            thread.name = "PowerTools Window Focus"
