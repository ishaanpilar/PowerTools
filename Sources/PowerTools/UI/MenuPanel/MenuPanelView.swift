...
extension Notification.Name {
    static let menuPanelWillShow = Notification.Name("PowerToolsMenuPanelWillShow")
}
...
struct KeepAwakeCard: View {
    ...
    @AppStorage(DefaultsKey.keepAwakeActiveIcon) private var keepAwakeActiveIcon = KeepAwakeActiveIcon.powertools.rawValue
