...
struct ScreenshotCaptureSettings: View {
    ...
    @AppStorage(DefaultsKey.screenshotHidePowerToolsWindows) private var hidePowerToolsWindows = true
        ...
        Group {
            ...
            Section {
                ...
                Text(strings.freezeCaption)
                    .font(.caption)
                    .foregroundStyle(.secondary)
                Toggle(strings.hidePowerToolsWindowsToggle, isOn: $hidePowerToolsWindows)
