        ...
        return [
            ...
            (categories.windowsControls, [
                ...
                SettingsDirectoryItem(page: .alwaysOnTop,
                                      ...
                                      icon: "pin.fill",
                                      keywords: [FeatureStrings.alwaysOnTop(language).pinnedSectionTitle]),
            ...
            (categories.files, [
                ...
                SettingsDirectoryItem(page: .cutPaste,
                                       ...
                                       featureKeywords: [
                                        ...
                                        (.finderActions,
                                         [FeatureStrings.finderActions(language).hubTitle,
                                          FeatureStrings.finderActions(language).enableLabel]),
                                       ]),
            ...
            (categories.utilities, [
                ...
                SettingsDirectoryItem(page: .aiTextActions,
