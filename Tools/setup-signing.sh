...
# Creates a stable, self-signed code-signing identity named "PowerTools Utils
...
#
# This identity name keeps its original "PowerTools Signing" on purpose: it
...
IDENTITY="PowerTools Signing"
KC="$HOME/Library/Keychains/powertools-signing.keychain-db"
KCPASS="powertools-signing"
